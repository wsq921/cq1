...
class AerationDetectionSystem(QMainWindow):
    ...
    def setup_ui(self):
        ...
        for i in range(self.channel_count):
            ...
            # Set initial values
            self.data_table.setItem(i, 1, QTableWidgetItem("0"))
            self.data_table.setItem(i, 2, QTableWidgetItem("0"))
            self.data_table.setItem(i, 3, QTableWidgetItem("3000"))
            self.data_table.setItem(i, 4, QTableWidgetItem("0.00"))
